...
class FriendsViewModel : ViewModel() {
    ...
    fun setIntercomService(service: IntercomService?) {
        ...
        if (service != null) {
            _message.value = "Arkadaşlar servisi bağlandı"
        } else {
            _message.value = "Arkadaşlar servisi bulunamadı"
        }
    }
    ...
    private fun saveFriendsToLocal(friends: List<Friend>) {
        ...
        android.util.Log.d("FriendsViewModel", "Saving ${friends.size} friends to local storage")
    }
