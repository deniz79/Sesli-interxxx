...
public final class ItemFriendBinding implements ViewBinding {
  ...
  private ItemFriendBinding(@NonNull CardView rootView, @NonNull ImageView ivAvatar,
      @NonNull ImageView ivCall, @NonNull TextView tvName, @NonNull TextView tvStatus) {
  ...
  public static ItemFriendBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFriendBinding((CardView) rootView, ivAvatar, ivCall, tvName, tvStatus);
    }
